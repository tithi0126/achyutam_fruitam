...
export const Contact = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const message = `Hello Icecream Shop!
                ...
                <div className="grid md:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-brand-light mb-8 relative z-10 font-light">
                            Ready to start your journey with Icecream Shop? Reach out for franchise opportunities or general queries.
                        </p>
                        ...
                        <div className="space-y-6 relative z-10">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-semibold mt-1">hello@icecreamshop.com</p>
                                    <p className="text-lg font-semibold">franchise@icecreamshop.com</p>
                                </div>
                            </div>
                        ...
                        <div className="mt-12 pt-8 border-t border-white/10 relative z-10">
                            ...
                            <div className="flex gap-4">
                                {/* Social Icons */}
                                <a href="https://instagram.com/icecream_shop" target="_blank" rel="noopener noreferrer" className="bg-white/10 p-2 rounded-full hover:bg-white/20 transition-colors">
                                ...
                                <a href="https://facebook.com/icecreamshop" target="_blank" rel="noopener noreferrer" className="bg-white/10 p-2 rounded-full hover:bg-white/20 transition-colors">
